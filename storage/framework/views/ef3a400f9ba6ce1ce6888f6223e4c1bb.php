    ...
    <?php else: ?>
        ...
        <table class="text-center text-2xl m-auto mt-5 bg-red-200 rounded-lg">
            ...
            <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parcela): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="px-6 py-4"><?php echo e($parcela->locTer); ?></td>
                    <td class="px-6 py-4"><?php echo e($parcela->tamTer); ?>ha</td>
                    <td class="px-6 py-4"><?php echo e($parcela->semTer); ?></td>
                    <td class="px-6 py-4">
                        <a href="<?php echo e(route("parcela.editar", $parcela->idPar)); ?>"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
