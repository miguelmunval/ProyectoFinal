    ...
    @else
        @empty($datos)
            ...
            <div class="flex items-center justify-end mr-4">
                <a href="{{ route("objeto.crear")}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">@lang('app.nueObj')</a>
            </div>
        @else
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left">
                        <h6 class="my-5 mx-4 text-2xl">@lang('app.listObj')</h6>
                    </div>
                    <div class="flex items-center justify-end mr-4">
                        <a href="{{ route("objeto.crear")}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">@lang('app.nueObj')</a>
                    </div>
            ...
            <div class="overflow-x-auto mx-4">
                <table class="text-center text-2xl m-auto mt-5 bg-red-200 rounded-lg">
                    <tr>
                        ...
                        <th class="pt-6 px-8">@lang('app.des')</th>
