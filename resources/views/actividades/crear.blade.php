            ...
            <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-5">
                            <label for="idPar">@lang('app.elpar')</label>
                            <select name="idPar" id="idPar">
                                <option selected disabled readonly>@lang('app.tPar')</option>
                                @foreach ($parcelas as $parcela)
                                    <option value="{{$parcela->idPar}}">{{$parcela->locPar}}</option>
                                @endforeach
                        </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-5">
                        <label for="desAct">@lang('app.desAct')</label>
                        <input type="text" name="desAct" id="desAct">
                    </div>
                </div>
